...
package at.nineyards.qrcodescanner.history;
...
public final class HistoryManager {
    ...
    public boolean hasHistoryItems() {
        ...
        try (SQLiteDatabase db = helper.getReadableDatabase();
             Cursor cursor = db.query(DBHelper.TABLE_NAME, COUNT_COLUMN, null, null, null, null,
                     null)) {
            cursor.moveToFirst();
        ...
        try (SQLiteDatabase db = helper.getWritableDatabase();
            ...
            while (cursor.moveToNext()) {
                ...
                historyText.append('"').append(
                        massageHistoryField(format.format(timestamp))).append("\",");
    ...
    static Uri saveHistory(String history) {
        ...
        try (OutputStreamWriter out = new OutputStreamWriter(new FileOutputStream(historyFile),
