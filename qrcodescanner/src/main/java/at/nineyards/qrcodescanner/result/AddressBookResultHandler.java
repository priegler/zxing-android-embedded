...
public final class AddressBookResultHandler extends ResultHandler {
    ...
    public AddressBookResultHandler(Activity activity, ParsedResult result) {
        ...
        fields[1] = addresses != null && addresses.length > 0 && addresses[0] != null
                && !addresses[0].isEmpty();
    ...
    public int getButtonIcon(int index) {
        return BUTTON_ICONS[mapIndexToAction(index)];
    }
    ...
    public void handleButtonPress(int index) {
        ...
        String address1Type =
                addressTypes == null || addressTypes.length < 1 ? null : addressTypes[0];
    ...
    public CharSequence getDisplayContents() {
        ...
        if (birthday != null && !birthday.isEmpty()) {
            ...
            if (date >= 0L) {
                ParsedResult.maybeAppend(DateFormat.getDateInstance(DateFormat.MEDIUM).format(date),
                        contents);
            }
        }
