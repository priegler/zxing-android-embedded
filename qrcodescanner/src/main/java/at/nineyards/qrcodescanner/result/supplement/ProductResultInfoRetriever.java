...
package at.nineyards.qrcodescanner.result.supplement;
...
import at.nineyards.qrcodescanner.HttpHelper;
...
final class ProductResultInfoRetriever extends SupplementalInfoRetriever {
    ...
    ProductResultInfoRetriever(TextView textView, String productID, HistoryManager historyManager,
            Context context) {
